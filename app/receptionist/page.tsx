...
export const metadata: Metadata = {
  ...
  description:
    "GrowVera's AI receptionist answers every call you can't take — on the tools, after hours, on a break. It only picks up when you don't, captures the job, books it, and texts you a summary. From $650/mo + one-off setup.",
};
