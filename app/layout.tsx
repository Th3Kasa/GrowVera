...
export const metadata: Metadata = {
  ...
  description:
    "An AI receptionist that only answers when you can't, plus in-house quoting your team runs — for Australian trades and local services. You still pick up first; customers never talk to a machine unless you choose. Priced to your business on a free AI audit call.",
  keywords:
  ...
  openGraph: {
    title: "GrowVera — Never miss a call. Never lose a job.",
    description:
      "An AI receptionist that answers the calls you can't, and in-house quoting done in seconds — for Australian trades. You pick up first; customers only meet AI if you choose. Priced to your business on a free audit call.",
