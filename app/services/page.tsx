      ...
      <section style={{ background: "#0E0E11" }}>
        ...
        >
          <ScrollReveal>
            ...
            <p style={{ color: "#A2A2A0", fontSize: "1.0625rem", lineHeight: 1.7, maxWidth: "540px", margin: "0 auto" }}>
      ...
      <section>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingTop: "clamp(2.5rem, 5vw, 4rem)", paddingBottom: "clamp(2rem, 4vw, 3rem)" }}>
              ...
              return (
                <ScrollReveal key={a.name} delay={i * 0.07}>
                  <div style={{ background: "#131318", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "1.25rem", padding: "2rem", height: "100%" }}>
                    ...
                    <h2 style={{ fontFamily: "var(--font-cabinet), Outfit, sans-serif", fontSize: "1.25rem", fontWeight: 800, color: "#F4F4F1", marginBottom: "0.6rem", letterSpacing: "-0.02em" }}>{a.name}</h2>
                    <p style={{ fontSize: "0.9rem", color: "#A2A2A0", lineHeight: 1.65 }}>{a.desc}</p>
                  </div>
                </ScrollReveal>
              );
            })}
          ...
          <ScrollReveal delay={0.2}>
            <p style={{ textAlign: "center", fontSize: "0.85rem", color: "#6E6E72", marginTop: "2rem", maxWidth: "40rem", marginInline: "auto", lineHeight: 1.6 }}>
      ...
      <section>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" style={{ paddingBottom: "clamp(4rem, 8vw, 7rem)" }}>
          <div style={{ background: "linear-gradient(135deg, #16A34A 0%, #1A5C3A 100%)", borderRadius: "20px", padding: "clamp(32px, 5vw, 52px)", textAlign: "center" }}>
            ...
            <p style={{ color: "rgba(255,255,255,0.80)", fontSize: "15px", lineHeight: 1.7, marginBottom: "28px", maxWidth: "420px", margin: "0 auto 28px" }}>
