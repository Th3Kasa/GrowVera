...
export const metadata: Metadata = {
  ...
  description:
    "GrowVera builds your team an in-house quoting tool wired to your own price lists, rates and margins — only your staff use it. Quotes that ate 15 minutes take seconds. Priced to your business on a free AI audit call.",
};
