    ...
    return (
      ...
      >
        ...
        <h3
          ...
          style={{ fontFamily: "var(--font-outfit)", color: "#0D0D0B" }}
        >
          You&apos;re on the list.
        </h3>
        <p
        ...
        <div
          className="mt-8 px-5 py-3 rounded-full text-sm font-medium"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => Object.assign(e.target.style, focusStyle)}
              onBlur={(e) => {
                e.target.style.borderColor = errors.yourName
                  ? "#DC2626"
                  : "rgba(13,13,11,0.12)";
                e.target.style.boxShadow = "none";
              }}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onFocus={(e) => Object.assign(e.target.style, focusStyle)}
              onBlur={(e) => {
                e.target.style.borderColor = errors.suburb
                  ? "#DC2626"
                  : "rgba(13,13,11,0.12)";
                e.target.style.boxShadow = "none";
              }}
